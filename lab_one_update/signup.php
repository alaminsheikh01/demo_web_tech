...
<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" novalidate style>
		<fieldset>
		...
		<input class="button" style="margin-top:10px" type="submit" name="submit" value="Register">
